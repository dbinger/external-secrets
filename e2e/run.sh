...
kubectl run --rm \
  ...
  --env="SECRETSERVER_SITE_ID=${SECRETSERVER_SITE_ID:-}" \
  --env="SECRETSERVER_FOLDER_ID=${SECRETSERVER_FOLDER_ID:-}" \
  --env="SECRETSERVER_TEMPLATE_ID=${SECRETSERVER_TEMPLATE_ID:-}" \
  --env="SECRETSERVER_DATA_FIELD_ID=${SECRETSERVER_DATA_FIELD_ID:-}" \
  --env="SECRETSERVER_REQUIRED_PASSWORD_FIELD_ID=${SECRETSERVER_REQUIRED_PASSWORD_FIELD_ID:-}" \
  --env="SECRETSERVER_REQUIRED_PASSWORD_VALUE=${SECRETSERVER_REQUIRED_PASSWORD_VALUE:-}" \
